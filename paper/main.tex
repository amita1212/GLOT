...
language models, the same $\tau$ that yields a $0.149$-density graph on BERT
yields a density of $0.992$ on RoBERTa, $0.996$ on ModernBERT and $0.731$ on
SmolLM2. For RoBERTa the tenth-percentile token cosine is $0.701$, above
...
\midrule
BERT-base        & 0.081 & 0.401 & 0.623 & 0.850 & 0.638 & \textbf{0.149} \\
RoBERTa-base     & 0.701 & 0.838 & 0.906 & 1.000 & 1.000 & \textbf{0.992} \\
ModernBERT-base  & \TODO{} & \TODO{} & \TODO{} & \TODO{} & \TODO{} & \textbf{0.996} \\
SmolLM2-360M     & 0.274 & 0.736 & 0.889 & 0.933 & 0.907 & 0.731 \\
TinyLlama-1.1B   & $-0.010$ & 0.349 & 0.595 & 0.780 & 0.568 & \textbf{0.121} \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
...
regime ($0.121$ at $\tau=0.6$) whereas SmolLM2 does not
